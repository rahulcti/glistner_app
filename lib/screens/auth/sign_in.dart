...
import 'package:glistener/screens/auth/choose_instrument.dart';
...
class _SignInState extends State<SignIn> {
 ...
 // ProgressDialog? progressDialog;
  ...
  var status,message,id,emailad,userfirst,userlast,data,isselected,login_status,token;
  String? name,imgurl;
  ...
  Future<Verify_Model> Verify() async {
    ...
    print("VerifyCLICKED 144444545544554 ==${isselected}");
  ...
  Future<LoginModel> login() async {
    print("CLICKEDddddddddddddddddd 123 ==${isselected}");
    initConnectivity();
    ...
    // No-Internet Case
    var response = await http.post(Uri.parse(BASE_URL+loginapi), body: toMap());
    ...
    print(LoginModel.fromJson(json.decode(response.body)).token.toString());
    status = (LoginModel.fromJson(json.decode(response.body)).status);
    message = (LoginModel.fromJson(json.decode(response.body)).message);
    token = (LoginModel.fromJson(json.decode(response.body)).token.toString());
    ...
    if(status==200){
      ...
      userfirst = (LoginModel.fromJson(json.decode(response.body)).userinfo?.firstname.toString());
      userlast = (LoginModel.fromJson(json.decode(response.body)).userinfo?.lastname.toString());
      ...
      image = (LoginModel.fromJson(json.decode(response.body)).userinfo!.image.toString());
      image = (LoginModel.fromJson(json.decode(response.body)).userinfo!.image.toString());
      login_status = (LoginModel.fromJson(json.decode(response.body)).userinfo!.login_status);

      SharedPreferences prefs = await SharedPreferences.getInstance();

      prefs.setString('login_user_token',token.toString());
      prefs.setString('userfirst',userfirst);
      prefs.setString('isselected',isselected.toString());
      var ooo=prefs.getString("isselected");
      print("akakakaakakaka${ooo}");
...
// });
  ...
  Future<MyProfile_Model> myprofile() async {
    ...
    var response = await http.post(Uri.parse(BASE_URL+userProfileapi), body: toMap1());
    // showLoaderDialog(context);
    ...
    setState(() async {
      ...
      imgurl = MyProfile_Model.fromJson(json.decode(response.body)).data?.image;
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Text.rich(
                                    TextSpan(
                                      children: [
                                        TextSpan(text: 'Don’t have an account?  ',style:TextStyle(color: colorhintcolor ,fontFamily: 'Poppins',
                                        ...
                                        TextSpan(
                                           ...
                                           recognizer: TapGestureRecognizer()
                                            ..onTap = () {
                                              print('///////');
                                              Get.off(() => SignUp());
                                              // Navigator.of(context).pushReplacement(createRoute(SignUp()));
