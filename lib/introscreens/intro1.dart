                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Be your own classy & creative music editor',
                            style: TextStyle(
                          ...
                          Text('Create fantastic multiple tracks'
                              ' using your favorite songs within the app.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                          ...
                          SvgPicture.asset("assets/new/intro1.svg",color: colorblack,),
                          InkWell(
                            onTap: (){
                              Navigator.of(context).pushReplacement(createRoute(Itro2()));
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                  color:  HexColor("#0D8EC5"),
                    ...
                    Positioned(
                      ...
                      child: Image.asset('assets/new/introimage1.png',
                        height: deviceheight(context,0.4),),
                    ),
                  ],
                ),
